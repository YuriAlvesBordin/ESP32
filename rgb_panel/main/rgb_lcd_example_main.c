...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                            //////////////////// configuration LCD spec //////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#define LCD_PIXEL_CLOCK_HZ     (9 * 1000 * 1000)

#define  PIN_NUM_BK_LIGHT       10 // BackLight
#define  PIN_NUM_HSYNC          39 // HSYNC
#define  PIN_NUM_VSYNC          41 // VSYNC
#define  PIN_NUM_DE             4 // DE
#define  PIN_NUM_PCLK           40 // PCLK

#define PIN_NUM_DATA0          8 // B0
#define PIN_NUM_DATA1          3 // B1
#define PIN_NUM_DATA2          46 // B2
#define PIN_NUM_DATA3          9 // B3
#define PIN_NUM_DATA4          0 // B4

#define PIN_NUM_DATA5          12 // G0 36 Causa Reset 
#define PIN_NUM_DATA6          11 // G1 35 Causa Reset
#define PIN_NUM_DATA7          7 // G2
#define PIN_NUM_DATA8          15 // G3
#define PIN_NUM_DATA9          16 // G4
#define PIN_NUM_DATA10         13 // G5 37 Causa Reset

#define PIN_NUM_DATA11         45  // R0
#define PIN_NUM_DATA12         48 // R1
#define PIN_NUM_DATA13         47 // R2
#define PIN_NUM_DATA14         21 // R3
#define PIN_NUM_DATA15         42 // R4
...
void touch_interrupt_handler(lv_indev_drv_t * indevDriver, lv_indev_data_t * indevData)
{
    ...
    if (pressure > 10 && pressure < 4000 && pos[0] > 0 && pos[1] > 0) {
